...
import { StateCarHistory } from './lists/lists-widget5/state-car-hisory.component';
...
import { PaginationWidget1Component } from './pagination/pagination.component';
